...
export default function SellBuyWorld() {
  return (
    <div className="relative z-10 pb-6 mt-6">
      <div className="z-20 flex flex-wrap gap-6 mx-6 justify-evenly">
        ...
        <Link
          to="/sell"
          className="flex shadow-thema3 items-center justify-center w-[300px] h-[100px] transform transition duration-500 hover:scale-110 hover:shadow-2xl hover:bg-thema3 rounded-full shadow-md  bg-thema2 border-thema3"
        >
